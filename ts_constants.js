...
module.exports = {
    INCOMING_CASES_QUERY: 'http://localhost:3000/auth/localUploader/all-cases/?test_key=0Wbjj49mZtRZ5YtcShGaIb10JbdNxEtezdZi2eios4w0TDcxPjRC',
    INCOMING_REDESIGNS_QUERY: 'http://localhost:3000/auth/localUploader/redesign-cases/?test_key=0Wbjj49mZtRZ5YtcShGaIb10JbdNxEtezdZi2eios4w0TDcxPjRC',
    UPDATE_REDESIGN_STATUS_ENDPOINT: 'http://localhost:3000/auth/localUploader/update-casefiles',
    CONSTANTS_POST_ENDPOINT: 'http://localhost:3000/auth/localUploader/set-constants',
    CONSTANTS_GET_ENDPOINT: 'http://localhost:3000/auth/localUploader/get-constants',
}